...
type MomentumPool interface {
	...
	// GetMomentumPatch returns a copy of the state patch stored for the
	// momentum with this identifier, as the manager holds it, frontier writes
	// included, or nil if there is none.
